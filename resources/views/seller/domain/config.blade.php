                ...
                <div class="modal-card card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <h6>For video tutorial please follow <a href="https://drive.google.com/file/d/1QZmnJuzBkThAgWLcqkOT0igKiaUlspNt/view?usp=sharing" target="_blank">Link</a></h4>
                            <small class="form-text text-muted">{{ $dns->support_instruction ?? 'something' }}</small>
                        </div>
                    </div>
                </div>
